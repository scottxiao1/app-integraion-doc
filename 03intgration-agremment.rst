...
+--------------------+----------------+-------+-------------------------------------------------------+
| make               | string         | 是    | 设备品牌(小写)；例如：apple                           |
+--------------------+----------------+-------+-------------------------------------------------------+
| model              | string         | 是    | 设备型号(小写)；例如：iphone                          |
+--------------------+----------------+-------+-------------------------------------------------------+
| hwv                | string         | 是    | 设备的硬件版本（Hardware version）；例如：            |
|                    |                |       | “5S”，iPhone 5s 的“5S”                                |
+--------------------+----------------+-------+-------------------------------------------------------+
| os                 | string         | 是    | 操作系统，0-UNKNOWN，1-iOS，2-Android，               |
|                    |                |       | 3-WindowsPhone，例如：1                               |
+--------------------+----------------+-------+-------------------------------------------------------+
| osv                | string         | 是    | 操作系统版本；例如：7.0.2                             |
+--------------------+----------------+-------+-------------------------------------------------------+
...
| ua                 | string         | 是    | 浏览器用户代理                                        |
+--------------------+----------------+-------+-------------------------------------------------------+
| ip                 | string         | 是    | 手机设备IP 地址，ipv4；例如：8.8.8.8                  |
+--------------------+----------------+-------+-------------------------------------------------------+
| geo                | object         | 否    | 设备地理位置信息                                      |
+--------------------+----------------+-------+-------------------------------------------------------+
| ifa                | string         | 是    | IOS 设备idfa，原始值；例如：e4273e31-97a9-            |
|                    |                |       |     4b29-93a8-8a99f0cea068                            |
+--------------------+----------------+-------+-------------------------------------------------------+
| ifa_md5            | string         | 是    | IOS 设备idfa，md5 加密值；例如：e4273e31-97a9-        |
|                    |                |       |     4b29-93a8-8a99f0cea068                            |
+--------------------+----------------+-------+-------------------------------------------------------+
| android_id         | string         | 是    | android 设备的android id，原始值                      |
|                    |                |       |                                                       |
+--------------------+----------------+-------+-------------------------------------------------------+
| android_id_md5     | string         | 是    | android 设备的android id，md5 加密值                  |
|                    |                |       |                                                       |
+--------------------+----------------+-------+-------------------------------------------------------+
| imei               | string         | 是    | imei 原始值                                           |
+--------------------+----------------+-------+-------------------------------------------------------+
| imei_md5           | string         | 是    | imei,md5加密值                                        |
+--------------------+----------------+-------+-------------------------------------------------------+
| mac                | string         | 是    | 手机设备mac原始值，大写去除冒号分隔符                 |
+--------------------+----------------+-------+-------------------------------------------------------+
| mac_md5            | string         | 是    | 手机设备mac的md5加密值，大写去除冒号分隔符            |
+--------------------+----------------+-------+-------------------------------------------------------+
| duid               | string         | 是    | Windows Phone 设备DUID，原始值                        |
+--------------------+----------------+-------+-------------------------------------------------------+
| duid_md5           | string         | 是    | Windows Phone 设备DUID，md5加密值                     |
+--------------------+----------------+-------+-------------------------------------------------------+
...
|                     |                |       | 见附录“广告位返回广 告元素参照表”                     |
+---------------------+----------------+-------+-------------------------------------------------------+
| site_url            | string         | 否    | 推广标的物料地址，最终落地页地址                      |
|                     |                |       |                                                       |
+---------------------+----------------+-------+-------------------------------------------------------+
| click_tracking_url  | string         | 否    | 该字段已废止，下个版本更新后删除，请使用              |
|                     |                |       | click_through_url替代                                 |
|                     |                |       |                                                       |
+---------------------+----------------+-------+-------------------------------------------------------+
| click_tracking_urls | array          | 否    | 异步点击监测地址，最多同时支持3条                     |
|                     |                |       |                                                       |
|                     |                |       | 注:仅存在异步上报地址时，媒体客户端需要再点击响应     |
|                     |                |       | site_url或click_through_url跳转的同时，单独上报       |
|                     |                |       | （call）单条或多条异步点击监测地址                    |
+---------------------+----------------+-------+-------------------------------------------------------+
